...
def load_gbnet_checkpoint(model, fpath):
    ...
    with torch_no_grad():
        model.roi_heads.relation.predictor.ggnn.fc_mp_receive_ont_ent.model[0].weight.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_receive_ont_ent.model.0.linear.weight'])
        ...
        model.roi_heads.relation.predictor.ggnn.fc_mp_receive_ont_pred.model[0].weight.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_receive_ont_pred.model.0.linear.weight'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_receive_ont_ent.model[2].weight.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_receive_ont_ent.model.2.linear.weight'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_receive_ont_pred.model[2].weight.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_receive_ont_pred.model.2.linear.weight'])
        ...
        model.roi_heads.relation.predictor.ggnn.fc_output_proj_img_pred.model[0].weight.copy_(state_dict['ggnn_rel_reason.ggnn.fc_output_proj_img_pred.model.0.linear.weight'])
        model.roi_heads.relation.predictor.ggnn.fc_output_proj_img_pred.model[2].weight.copy_(state_dict['ggnn_rel_reason.ggnn.fc_output_proj_img_pred.model.2.linear.weight'])
        model.roi_heads.relation.predictor.ggnn.fc_output_proj_ont_pred.model[0].weight.copy_(state_dict['ggnn_rel_reason.ggnn.fc_output_proj_ont_pred.model.0.linear.weight'])
        model.roi_heads.relation.predictor.ggnn.fc_output_proj_ont_pred.model[2].weight.copy_(state_dict['ggnn_rel_reason.ggnn.fc_output_proj_ont_pred.model.2.linear.weight'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_receive_img_ent.model[2].weight.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_receive_img_ent.model.2.linear.weight'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_receive_img_pred.model[2].weight.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_receive_img_pred.model.2.linear.weight'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_receive_img_ent.model[0].weight.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_receive_img_ent.model.0.linear.weight'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_receive_img_pred.model[0].weight.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_receive_img_pred.model.0.linear.weight'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_send_ont_ent.model[0].weight.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_send_ont_ent.model.0.linear.weight'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_send_ont_pred.model[0].weight.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_send_ont_pred.model.0.linear.weight'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_send_img_ent.model[0].weight.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_send_img_ent.model.0.linear.weight'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_send_img_pred.model[0].weight.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_send_img_pred.model.0.linear.weight'])
        ...
        model.roi_heads.relation.predictor.ggnn.fc_mp_send_ont_ent.model[2].weight.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_send_ont_ent.model.2.linear.weight'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_send_ont_pred.model[2].weight.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_send_ont_pred.model.2.linear.weight'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_send_img_ent.model[2].weight.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_send_img_ent.model.2.linear.weight'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_send_img_pred.model[2].weight.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_send_img_pred.model.2.linear.weight'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_receive_ont_ent.model[0].bias.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_receive_ont_ent.model.0.linear.bias'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_receive_ont_pred.model[0].bias.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_receive_ont_pred.model.0.linear.bias'])
        ...
        model.roi_heads.relation.predictor.ggnn.fc_mp_receive_ont_ent.model[2].bias.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_receive_ont_ent.model.2.linear.bias'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_receive_ont_pred.model[2].bias.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_receive_ont_pred.model.2.linear.bias'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_receive_img_ent.model[2].bias.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_receive_img_ent.model.2.linear.bias'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_receive_img_pred.model[2].bias.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_receive_img_pred.model.2.linear.bias'])
        ...
        model.roi_heads.relation.predictor.ggnn.fc_output_proj_img_pred.model[0].bias.copy_(state_dict['ggnn_rel_reason.ggnn.fc_output_proj_img_pred.model.0.linear.bias'])
        model.roi_heads.relation.predictor.ggnn.fc_output_proj_img_pred.model[2].bias.copy_(state_dict['ggnn_rel_reason.ggnn.fc_output_proj_img_pred.model.2.linear.bias'])
        model.roi_heads.relation.predictor.ggnn.fc_output_proj_ont_pred.model[0].bias.copy_(state_dict['ggnn_rel_reason.ggnn.fc_output_proj_ont_pred.model.0.linear.bias'])
        model.roi_heads.relation.predictor.ggnn.fc_output_proj_ont_pred.model[2].bias.copy_(state_dict['ggnn_rel_reason.ggnn.fc_output_proj_ont_pred.model.2.linear.bias'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_receive_img_ent.model[0].bias.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_receive_img_ent.model.0.linear.bias'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_receive_img_pred.model[0].bias.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_receive_img_pred.model.0.linear.bias'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_send_ont_ent.model[0].bias.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_send_ont_ent.model.0.linear.bias'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_send_ont_pred.model[0].bias.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_send_ont_pred.model.0.linear.bias'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_send_img_ent.model[0].bias.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_send_img_ent.model.0.linear.bias'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_send_img_pred.model[0].bias.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_send_img_pred.model.0.linear.bias'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_send_ont_ent.model[2].bias.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_send_ont_ent.model.2.linear.bias'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_send_ont_pred.model[2].bias.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_send_ont_pred.model.2.linear.bias'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_send_img_ent.model[2].bias.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_send_img_ent.model.2.linear.bias'])
        model.roi_heads.relation.predictor.ggnn.fc_mp_send_img_pred.model[2].bias.copy_(state_dict['ggnn_rel_reason.ggnn.fc_mp_send_img_pred.model.2.linear.bias'])
    del state_dict
