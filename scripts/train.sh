...
if [ $1 == "0" ]; then
    ...
    MODEL_NAME="transformer_predcls_dist15_2k_FixPModel_lr1e3_B16_FCMat_BPL" #"transformer_predcls_dist15_2k_KD0_8_KLt1_freq_TranN2C_1_0_KLt1_InitPreModel_lr1e4"
    ...
    DTYPE "float32" \
    SOLVER.IMS_PER_BATCH 32 TEST.IMS_PER_BATCH $NUM_GPU \
    ...
    MODEL.PRETRAINED_MODEL_CKPT /home/zhanwen/bpl_og/checkpoints/transformer_predcls_dist15_3k_FixPModel_lr1e3_B16_FCMat/model_0014000.pth \
    ...
    MODEL.ROI_RELATION_HEAD.PREDICT_USE_BIAS True \
    DTYPE "float32" \
    SOLVER.IMS_PER_BATCH 16 TEST.IMS_PER_BATCH $NUM_GPU \
    SOLVER.MAX_ITER 16000 SOLVER.BASE_LR 1e-3 \
    SOLVER.SCHEDULE.TYPE WarmupMultiStepLR \
    SOLVER.STEPS "(10000, 16000)" SOLVER.VAL_PERIOD 2000 \
    SOLVER.CHECKPOINT_PERIOD 2000 GLOVE_DIR ./datasets/vg/ \
