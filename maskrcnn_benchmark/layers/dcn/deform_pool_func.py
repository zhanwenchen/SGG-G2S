...
from maskrcnn_benchmark._C import (
    deform_psroi_pooling_forward as _C_deform_psroi_pooling_forward,
    deform_psroi_pooling_backward as _C_deform_psroi_pooling_backward
)
...
class DeformRoIPoolingFunction(Function):
    ...
    def forward(
        ...
        _C_deform_psroi_pooling_forward(
            data,
            rois,
            offset,
            output,
    ...
    def backward(ctx, grad_output):
        ...
        _C_deform_psroi_pooling_backward(
            grad_output,
            data,
            rois,
            offset,
