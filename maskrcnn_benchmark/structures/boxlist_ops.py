...
from torch import max as torch_max, min as torch_min, cat as torch_cat, from_numpy as torch_from_numpy
import scipy.linalg
...
def cat_boxlist(bboxes):
    ...
    for field in fields:
        if field in bboxes[0].triplet_extra_fields:
            ...
            data = torch_from_numpy(scipy.linalg.block_diag(*triplet_list))
