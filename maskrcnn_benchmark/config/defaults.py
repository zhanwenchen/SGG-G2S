...
_C.MODEL.ROI_RELATION_HEAD.USE_GSC_FE = False

_C.MODEL.ROI_RELATION_HEAD.PAIRWISE = CN()
_C.MODEL.ROI_RELATION_HEAD.PAIRWISE.PAIRWISE_METHOD_DATA = ''
_C.MODEL.ROI_RELATION_HEAD.PAIRWISE.PAIRWISE_METHOD_FUNC = ''
_C.MODEL.ROI_RELATION_HEAD.PAIRWISE.FUSION_METHOD_ROI = 'sum'
_C.MODEL.ROI_RELATION_HEAD.PAIRWISE.FUSION_METHOD_FINAL = 'sum'
_C.MODEL.ROI_RELATION_HEAD.PAIRWISE.USE_PAIRWISE_L1 = False
_C.MODEL.ROI_RELATION_HEAD.PAIRWISE.USE_PAIRWISE_L2 = True
_C.MODEL.ROI_RELATION_HEAD.PAIRWISE.USE_PAIRWISE_L3 = False
...
_C.MODEL.ROI_RELATION_HEAD.PAIRWISE.LRGA = CN()
_C.MODEL.ROI_RELATION_HEAD.PAIRWISE.LRGA.K = 50
_C.MODEL.ROI_RELATION_HEAD.PAIRWISE.LRGA.DROPOUT = 0.1
...
_C.SOLVER.AUGMENTATION.NUM2AUG = 4
_C.SOLVER.AUGMENTATION.MAX_BATCHSIZE_AUG = 16
